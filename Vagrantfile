...
VM_PUB_NET         = "10.0.2."
VM_INT_NET         = "10.240.0." # need to set vm_pub_net_cidr in inventory using this
IP_START           = 100
VM_INT_IFACE       = "enp0s9"
VM_PUB_IFACE       = "enp0s8"
MYBOX              = "ubuntu/focal64" # various issues with focal, going back to bionic
K8S_VERSION        = "1.24.10"
...
VM_USERID                = "vagrant"
COREDNS_FORWARDS         = "10.0.2.1:53"
K8S_API_LB_IP            = "10.0.2.11"
  ...
  node.vm.provision "ansible" do |ansible|
    ...
    ansible.groups = {
      ...
      "all:vars"       => {
          ...
          "kubetools_kubectl_version" => K8S_VERSION,
          "kubetools_istioctl_version" => "1.17.0",
          "kubetools_user_id" => VBOX_HOST_USERID,
